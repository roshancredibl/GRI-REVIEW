...
const GRI202MarketPresenceImpact: React.FC = () => {
  ...
  const handleAnswersChange = (newAnswers: Record<string, any>) => {
    console.log(`GRI202 answers updated for report ${reportId}:`, newAnswers);
        ...
        <Suspense fallback={<div className="loading-spinner">Loading questionnaire...</div>}>
          {questionnaire ? (
            ...
            <div className="loading-container">
              <div className="loading-spinner">Loading GRI 202 questionnaire...</div>
            </div>
          ) : null}
        </Suspense>
      </div>
